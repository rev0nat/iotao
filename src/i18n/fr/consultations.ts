export default {
  ...
  overview: {
    cards: [
      {
        title: "Pour quels animaux ?",
        items: [
          "• Chiens",
          "• Chats",
          "• Chevaux",
          "• Animaux d'élevage",
          "• Pour tout autre animal, n'hésitez pas à me contacter",
        ],
      },

      {
        ...
        items: [
          ...
          "• Inconfort locomoteur",
          "• Récupération après un traumatisme",
          "• Suivi sportif",
          "• Accompagnement de gestation et des nouveau-nés",
          "• Accompagnement du vieillissement",
          "• Suivi complémentaire d'une prise en charge vétérinaire",
        ],
      },

      {
        ...
        items: [
          "• Échange et recueil des antécédents",
